        ...
        <h1>Add A facility</h1>
            ...
            <form action="process.php" method="post" enctype="multipart/form-data">
                ...
                <select name="bed_configuration" required class="text">
                    <option value="1 Double bed">1 Double</option>
                    <option value="1 Queen bed">1 Queen</option>
                    <option value="1 King Bed">1 King</option>
                    <option value="2 Single Beds">2 Single</option>
